...
SET /P env_name=enter an environment name (default = massmob_env):
IF NOT DEFINED env_name SET "env_name=massmob_env"
...
@echo on
echo Installing...
call python -m pip install -r requirements_win.txt --trusted-host pypi.org --trusted-host files.pythonhosted.org
